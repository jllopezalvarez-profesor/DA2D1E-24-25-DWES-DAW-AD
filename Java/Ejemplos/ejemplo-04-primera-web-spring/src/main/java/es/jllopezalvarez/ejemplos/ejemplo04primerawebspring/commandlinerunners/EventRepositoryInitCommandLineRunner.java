...
public class EventRepositoryInitCommandLineRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        eventRepository.save(new Event(1, "Evento 1", "Descripción evento 1", LocalDateTime.now(), LocalDateTime.now().plusDays(2)));
        eventRepository.save(new Event(2, "Evento 2", "Descripción evento 2", LocalDateTime.now(), LocalDateTime.now()));
        eventRepository.save(new Event(3, "Evento 3", "Descripción evento 1", LocalDateTime.now(), LocalDateTime.now()));
